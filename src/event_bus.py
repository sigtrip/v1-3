...
class EventBus:
    ...
    # ── ПУБЛИКАЦИЯ ────────────────────────────────────────
    def publish(self, topic: str, data: Any = None, source: str = "core", sync: bool = False):
    ...
    def emit(self, topic: str, data: Any = None, source: str = "core"):
        """Синоним publish для красивого кода."""
    ...
    def _dispatch(self, ev: Event):
        ...
        for h in handlers:
            try:
                ...
                log.error("EventBus handler %s error: %s", h.__name__, e)
